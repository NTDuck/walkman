...
async fn main() -> Fallible<()> {
    ...
    let metadata_writer = ::std::sync::Arc::new(Id3MetadataWriter::builder()
        ...
        .artists_naming_policy(match matches.get_one::<::std::string::String>("set-video-artists-as").ok()?.as_ref() {
    ...
    let download_playlist_interactor = ::std::sync::Arc::new(DownloadPlaylistInteractor::builder()
        ...
        .build());
    let download_channel_interactor = ::std::sync::Arc::new(DownloadChannelInteractor::builder()
        ...
        .build());
    let update_media_interactor = ::std::sync::Arc::new(UpdateMediaInteractor::builder()
