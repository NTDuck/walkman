...
pub trait Downloader: Send + Sync {
    ...
    async fn download_playlist(&self, url: MaybeOwnedString, directory: MaybeOwnedPath) -> Fallible<(BoxedStream<PlaylistDownloadEvent>, BoxedStream<VideoDownloadEvent>)>;
}
